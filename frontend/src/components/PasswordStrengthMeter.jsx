...
const PasswordCriteria = ({ password }) => {
	const criteria = [
		...
		{ label: "Contém letras maiúsculas", met: /[A-Z]/.test(password) },
		{ label: "Contém letras minúsculas", met: /[a-z]/.test(password) },
		{ label: "Contém um número", met: /\d/.test(password) },
		{ label: "Contém um carácter especial", met: /[^A-Za-z0-9]/.test(password) },
	];
